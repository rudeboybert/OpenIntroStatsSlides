%
%
% 1. Clear up method in general:  Make clear connection between Normal and Normal(0,1) and how standardization
% links the two.
% 2. Clean-up example: Use different values: no need for decimal place precision, it just makes things tedious.
% 3. Better explain values on x and y axis on QQplot
%
%
