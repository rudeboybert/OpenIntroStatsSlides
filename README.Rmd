---
title: "Slides for Intro Stats using OpenIntro Statistics"
output:
  html_document:
    keep_md: yes
---
...
## Usage
If you are unfamiliar with git forks, you can download all the files by clicking the "Download ZIP" icon in the right-hand side menu.  The file `All_Lectures.pdf` contains all slides combined.
