...
\pause\item Form a conclusion \pause and communicate it
\end{enumerate}
...
\begin{verbatim}
                   ...
                   Psychology                     Economics 
                            3                             2 
        Environmental Studies            Biology/Psychology 
                            2                             1 
                      English    Environmental Studies-Biol 
                            1                             1 
   Environmental Studies-Hist                       Physics 
                            1                             1 
            Political Science 
                            1 
\end{verbatim}
...
%------------------------------------------------------------------------------
\begin{frame}[fragile]
\frametitle{Math Colloquium}
\begin{itemize}
\item What: ``Mathematical Models for HIV Transmission Networks''
\item Who: UW Statistics and Sociology Prof. Martina Morris (Reed '80 sociology alum)
\item Where: Physics 123
\item When: Thursday January 29th
\end{itemize}
\end{frame}
%------------------------------------------------------------------------------
