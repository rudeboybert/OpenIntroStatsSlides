...
%\begin{frame}
%\frametitle{Recall Example about Reedie Sleep Habits}
%Since the p-value $0.007 < 0.05=\alpha$, it has a high degree of \blue{extremeness}, and thus we \blue{reject $H_0$}.
%
%\vspace{0.5cm}
%
%\blue{Final Conclusion}: we reject the hypothesis that the average \# of hours of sleep Reedies get is 7 hours in favor of the hypothesis that they get more, at the $\alpha=0.05$ significance level.  
%
%\end{frame}
%%-------------------------------------------------------------------------------
%
...
%\vspace{0.5cm}
%
%\blue{Incorrect interpretation of the p-value}:  The probability that the null hypothesis ($\mu=7$) is true is 0.007.  
%
%\end{frame}
%%-------------------------------------------------------------------------------
