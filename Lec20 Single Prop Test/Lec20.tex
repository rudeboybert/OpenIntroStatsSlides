...
%
%\vspace{0.25cm}
%\pause This happens when the population distribution of 0's and 1's is not too strongly skewed/the sample size $n \longrightarrow \infty$. 
%
%\vspace{0.25cm}
%\pause Note:  \[
...
%\pause \item We expect to see at least 10 successes and 10 failures.  This is the \blue{success-failure condition}:
%\begin{itemize}
%\item $np \geq 10$
%\item $n(1-p) \geq 10$ 
%\end{itemize}
