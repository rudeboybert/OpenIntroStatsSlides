...
```{r results="asis", echo = FALSE}
state$log_yr_2013 <- log10(ifelse(state$yr_2013 == 0, 1, state$yr_2013))
hist(state$log_yr_2013, xlab="log10(# of students)", main="log_10 of # of students from each state")
```
