...
%
%How do I verify normality of the population distribution with small $n$? Ask:
%
%\begin{itemize}
...
%$p$-Value: we use $t$-table on page 430, $df=24$ row:
%
%\begin{center}
...
%
%
%\pause Decision: Since the p-value $< \alpha=0.10$, we reject $H_0$ that NY'ers sleep 8 hours a night at the $\alpha=0.10$ significance level in favor of the hypothesis they sleep less.
\end{frame}
%-------------------------------------------------------------------------------
