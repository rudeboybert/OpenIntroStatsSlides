...
\end{center}
\blue{Two stage sampling}:  Very similar to stratified sampling in its process, except that there is no requirement to sample from every cluster.  First the clusters in red were chosen at random, and then we sample from them.
\end{frame}
%------------------------------------------------------------------------------
